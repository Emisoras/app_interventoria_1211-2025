// src/app/form/viabilidad-educativa/page.tsx
'use client';
...
export default function ViabilidadEducativaPage() {
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl md:text-2xl font-bold font-headline text-foreground">
              Check Viabilidad Institución Educativa
            </h1>
          </div>
      ...
      <main className="container mx-auto p-4 md:p-8 flex-grow">
        <SuspenseWrapper>
            <ChecklistForm 
                ...
                formTitle="CHECK DE ESTUDIO DE CAMPO PARA INSTITUCIONES EDUCATIVAS"
            />
        </SuspenseWrapper>
      </main>
