// src/app/form/instalacion/page.tsx
'use client';

import { ChecklistFormInstalacion } from '@/components/checklist-form-instalacion';
import { CheckInterventoriaLogo } from '@/components/check-interventoria-logo';
import { Button } from '@/components/ui/button';
import { useToast } from '@/hooks/use-toast';
import { ArrowLeft, History, LogOut, UserCircle } from 'lucide-react';
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl md:text-2xl font-bold font-headline text-foreground">
              Check Instalación Institución Educativa
            </h1>
          </div>
